...
?>
  ...
  <head>
    ...
    <title>Petshop Unpak Bogor Pesanan</title>
  </head>
            ...
            <tbody class="bg-light">
              ...
              <?php foreach ($result as $result) : ?>
                <tr>
                  ...
                  <td>
                    <a href="detail_pesanan.php?id=<?php echo $result['id_pemesanan'] ?>" class="badge badge-primary"><i class="fa-solid fa-circle-info"></i> Detail</a>
                    <a href="clear_pesanan.php?id=<?php echo $result['id_pemesanan'] ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" class="badge badge-danger"><i class="bi bi-trash-fill"></i> Hapus Pesanan</a>
                  </td>
                </tr>
                <?php $nomor++; ?>
              <?php endforeach; ?>
