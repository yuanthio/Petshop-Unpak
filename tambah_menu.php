...
<head>
  ...
  <title>Petshop Unpak Bogor Tambah Produk</title>
</head>
...
<body>
  ...
  <section class="tambah">
    <div class="container p-4 animate__animated animate__bounceInUp">
      <h3 class="text-center mb-5">TAMBAH PRODUK</h3>
      <div class="card p-5">
        <form method="POST" action="" enctype="multipart/form-data">
          <div class="form-group">
            <label for="menu1">Nama Produk</label>
            <input type="text" class="form-control" id="menu1" name="nama_menu" placeholder="Masukan Nama Produk" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="stok1" name="stok" placeholder="Masukan Jumlah Stok" required>
          </div>
          <div class="form-group">
            <label for="harga1">Harga Produk</label>
            <input type="text" class="form-control" id="harga1" name="harga" placeholder="Masukan Harga Produk" required>
          </div>
          <div class="form-group">
            <label for="gambar">Foto Produk</label>
            <input type="file" class="form-control-file border" id="gambar" name="gambar" required>
          </div><br>
          <button type="submit" class="btn btn-primary" name="tambah"><i class="bi bi-plus-lg"></i> Tambah</button>
